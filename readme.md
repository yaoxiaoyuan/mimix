...
3. cd src and run: 
   ...
   7. Chinese question similarity tool: interact.py --conf ../conf/sim_base_conf
      ...
      2. output:
         ...
         适合小孩听的歌 适合小孩听的歌 tensor(1.0000)
         适合小孩听的歌 推荐几首儿歌 tensor(0.7274)
         适合小孩听的歌 熬夜有什么坏处 tensor(0.1073)
         适合小孩听的歌 晚睡对身体的影响 tensor(0.1712)
         推荐几首儿歌 推荐几首儿歌 tensor(1.0000)
         推荐几首儿歌 熬夜有什么坏处 tensor(0.0169)
         推荐几首儿歌 晚睡对身体的影响 tensor(0.0154)
         熬夜有什么坏处 熬夜有什么坏处 tensor(1.0000)
         熬夜有什么坏处 晚睡对身体的影响 tensor(0.6903)
         晚睡对身体的影响 晚睡对身体的影响 tensor(1.0000)
