...
3. run: 
   ...
   **For streaming generation, just add --stream.**
   ...
   4. Chinese modern poet, lyric generation : python interact.py --model_conf conf/poet_base_conf
      ...
      prompts can be ['\_poet\_ \_title\_',  '\_lyric\_ \_title\_']
   ...
   7. Chinese question generation: 

      v2 model: python interact.py --model_conf conf/qg_base_conf_v2

      1. input: 泼水节又名"浴佛节"，傣语称为"桑堪比迈"（意为新年 [1]），西双版纳傣族自治区和德宏傣族景颇族自治区的傣族又称此节日为"尚罕"和"尚键"，两名称均源于梵语，意为周转、变更和转移，指太阳已经在黄道十二宫运转一周开始向新的一年过渡。阿昌、德昂、布朗、佤等族过这一节日。柬埔寨、泰国、缅甸、老挝等国也过泼水节。泼水节一般在傣历六月中旬(即农历清明前后 十天左右)举行，是西双版纳隆重的传统节日之一。其内容包括民俗活动、艺术表演、经贸交流等类别，具体节日活动有泼水、赶摆、赛龙舟、浴佛、诵经、章哈演唱和孔雀舞、白象舞表演等 。

      2. output:

         泼水节是在傣历六月中旬（即农历清明前后十天左右）举行的。 \_sep\_ 泼水节是在哪个时期举行的？  -0.11630507402641829

         泼水节是在傣历六月中旬（即农历清明前后十天左右）举行的。 \_sep\_ 泼水节是在哪个时间段举行的？  -0.1457874124700373

         泼水节是在傣历六月中旬举行的。 \_sep\_ 泼水节是在哪个时期举行的？  -0.1491348425547282
         
         西双版纳傣族自治区和德宏傣族景颇族自治区的傣族也称泼水节为"尚罕"和"尚键"。 \_sep\_ 哪些地区的傣族称泼水节为"尚罕"和"尚键"？  -0.17854947892446366
         
         西双版纳傣族自治区和德宏傣族景颇族自治区的傣族又称泼水节为"尚罕"和"尚键"。 \_sep\_ 哪些地区的傣族称泼水节为"尚罕"和"尚键"？  -0.1787497808062841
      
         

      v1 model: python interact.py --model_conf conf/qg_base_conf
   ...
   8. Chinese mrc: python interact.py --model_conf conf/mrc_base_conf

       1. input: 泼水节又名"浴佛节"，傣语称为"桑堪比迈"（意为新年 [1]），西双版纳傣族自治区和德宏傣族景颇族自治区的傣族又称此节日为"尚罕"和"尚键"，两名称均源于梵语，意为周转、变更和转移，指太阳已经在黄道十二宫运转一周开始向新的一年过渡。阿昌、德昂、布朗、佤等族过这一节日。柬埔寨、泰国、缅甸、老挝等国也过泼水节。泼水节一般在傣历六月中旬(即农历清明 前后十天左右)举行，是西双版纳隆重的传统节日之一。其内容包括民俗活动、艺术表演、经贸交流等类别，具体节日活动有泼水、赶摆、赛龙舟、浴佛、诵经、章哈演唱和孔雀舞、白象舞表 演等。\_sep\_哪些国家过泼水节？

       2. output:

           柬埔寨、泰国、缅甸、老挝等国也过泼水节。  -0.06632258210863386

           

   9. Chinese ancient translation: python interact.py --model_conf conf/a2m_base_conf
   ...
   10. Chinese comment generation: python interact.py --model_conf conf/comment_base_conf
   ...
   11. Chinese essay generation: python interact.py --model_conf conf/essay_base_conf
   ...
   12. Chinese qa generation: 

         v2 model: python interact.py --model_conf conf/qa_large_conf
         ...
         v1 model: python interact.py --model_conf conf/qa_base_conf
   ...
   13. Chinese product description generation: python interact.py --model_conf conf/desc_base_conf
   ...
   14. Chinese product review generation: python interact.py --model_conf conf/review_base_conf
   ...
   15. Chinese wuxia novel generation: python interact.py --model_conf conf/wx_base_conf
   ...
   16. Chinese novel generation: python interact.py --model_conf conf/novel_base_conf
   ...
   17. Chinese ancient novel generation: python interact.py --model_conf conf/ancient_novel_base_conf
