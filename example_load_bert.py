...
#Test for MLM: [MASK]国的首都是曼谷
#output: ['泰'] 0.9880752563476562
x = tokenizer.tokenize_to_ids("国的首都是曼谷")
y = model([torch.tensor([[101,103]+x], dtype=torch.long), torch.zeros([1,2+len(x)], dtype=torch.long)])[0]
...
#Test for MLM: [MASK]国的首都是首尔
#output: ['韩'] 0.8961494565010071
